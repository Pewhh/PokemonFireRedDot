...
#define EVO_FRIENDSHIP_ESPEON  2  // Pokémon levels up during the day with friendship ≥ 220
#define EVO_FRIENDSHIP_UMBREON 3  // Pokémon levels up at night with friendship ≥ 220
