...
const u8 gText_NoMoreThanVar1MayEnter[] = _("No more than {STR_VAR_1} POKéMON\nmay enter.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_NotEnoughMonsSelected[] = _("{STR_VAR_1} POKéMON must be\nselected.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_Fourth_PM[] = _("FOURTH");
